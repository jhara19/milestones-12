            ...
            <div className="modal">
                <div className="modal-box relative">
                    ...
                    <form onSubmit={handleBooking} className="grid grid-cols-1 gap-3 mt-10">
                        ...
                        <input type="text" name='name' placeholder="Your Name" defaultValue={user?.displayName} disabled className="input w-full input-bordered rounded-sm" />
                        <input type="email" name='email' placeholder="Your Email" defaultValue={user?.email} disabled className="input w-full input-bordered rounded-sm" />
