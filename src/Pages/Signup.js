        ...
        <div className='w-96 p-7'>
            ...
            <form onSubmit={handleSubmit(handelSignup)}>
                <div className="form-control w-full max-w-xs">
                   ...
                   {errors.email && <p className='text-red-600 font-bold'>{errors.name.message}</p>}
                </div>

                <div className="form-control w-full max-w-xs">
                    <label className="label"> <span className="label-text">Email</span></label>
                    <input type="email" {...register("email",{required:'Email is must be required'})}
                ...
                <br />
                <input className='btn btn-accent w-full mb-2' value="Signup" type="submit" />
